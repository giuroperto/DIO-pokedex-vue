<template>
	<div class="panel" :class="{ open: isOpen }">
		...
		<!-- quando clicar nessa div, quer que o isOpen receba true e abra -->
...
.panel {
	...
	// gera uma regra como se duas classes no mesmo elemento, se estiver separado vai considerar o open como filho da classe representada pelo &
	&.open {
		.panel--front,
		.panel--back {
	...
	&--back {
		...
		// remover a parte traseira -> visibilidade -> esconder para nao ocupar a parte do painel da direita frontal
